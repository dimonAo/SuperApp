...
public class MainFamilyAdapter extends BaseQuickAdapter<DeviceEntity, BaseViewHolder> {
    public MainFamilyAdapter(int layoutResId, @Nullable List<DeviceEntity> data) {
    ...
    protected void convert(BaseViewHolder helper, DeviceEntity item) {
        ...
        helper.setText(R.id.text_position, item.getPosition_name())
                .setText(R.id.text_device_name, item.getDevice_name());

        if (0 == item.getOn_line()) {
